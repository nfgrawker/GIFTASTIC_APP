...
emotionArray.forEach(function(emotion){
  var button = $("<button>")
  button.addClass("btn btn-info original m-2 gifbtn")
...
$(".mknew").on("click",function(){
  ...
  var button = $("<button>")
  button.addClass("btn btn-info new m-2 gifbtn")
...
$(document).on('click','.gifbtn',function(){
  ...
  $.ajax({
    url : "https://api.giphy.com/v1/gifs/search?q="+emotion+"&api_key="+apikey+"&limit=100",
    method : "GET"
